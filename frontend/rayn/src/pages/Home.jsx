        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4 md:py-6">
            ...
            <div className="hidden md:flex items-center gap-6 lg:gap-8">
              ...
              <Link to={"/onboarding"}><button className="bg-purple-600 hover:bg-purple-700 px-4 lg:px-6 py-2 rounded-full font-medium transition text-sm lg:text-base">
                Get Started
              </button>
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-purple-800/20">
            <div className="flex flex-col gap-4">
              ...
              <Link to={"/onboarding"}>  <button className="bg-purple-600 hover:bg-purple-700 px-6 py-2 rounded-full font-medium transition w-full">
                Get Started
              </button></Link>
            </div>
          </div>
    ...
    < section className = "bg-[#191022] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-20" >
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div className="order-2 lg:order-1">
         ...
         <Link to={"/onboarding"}> <button className="bg-purple-600 hover:bg-purple-700 px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-medium transition w-full sm:w-auto">
            Get Started
          </button></Link>
        </div>

export default function CTASection() {
  return (
    <section className="py-20 bg-gradient-to-r from-purple-700 via-purple-600 to-purple-500">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-16 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="/onboarding"
            className="bg-white text-purple-700 px-8 py-3 rounded-full font-semibold shadow-lg shadow-purple-900/40 transition-transform hover:scale-105"
          >
            Get Started
          </a>
          <a
            href="/community-giveaway"
            className="border border-white/60 text-white px-8 py-3 rounded-full font-semibold transition-colors hover:bg-white/10"
          >
            Learn More
          </a>
        </div>

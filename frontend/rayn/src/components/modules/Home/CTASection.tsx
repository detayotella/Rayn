  ...
  return (
    <section className="relative py-16 sm:py-24 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-purple-900/60 to-purple-800/40 backdrop-blur-xl rounded-3xl border border-purple-500/30 p-6 sm:p-10 lg:p-16 text-center shadow-2xl opacity-0 animate-scale-in">
          {/* Badge */}
          ...
          <h2 className="text-fluid-title font-bold mb-4 sm:mb-6 text-white leading-tight opacity-0 animate-fade-in-up delay-200">
          ...
          <p className="max-w-2xl mx-auto text-fluid-subtitle text-gray-300 mb-8 sm:mb-10 leading-relaxed opacity-0 animate-fade-in-up delay-300">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-purple-400/20 opacity-0 animate-fade-in-up delay-500">
